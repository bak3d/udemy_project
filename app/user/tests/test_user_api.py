...
class PublicUserApiTests(TestCase):
    ...
    def test_crete_token_for_user(self):
        ...
        payload = {'email':'test@slicelime.com','password': 'testpass'}
        create_user(**payload)
    ...
    def test_create_token_invalid_cred(self):
        """test that token is not created if invalid cred is given"""
        create_user(email='test@slicelime.com',password='testpass')
        payload = {'email':'test@slicelime.com','password': 'testpas'}
        res = self.client.post(TOKEN_URL,payload)
